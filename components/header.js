  ...
  return (
    <>
      {visible && (
        ...
        <p class="text-md text-white mt-1 text-center">Welcome to the third rewrite of the MSHA Builders Club site! If you find any bugs or have any other feedback please complete <a href="https://forms.gle/xezWd6mZX7fDxvEVA">this form.</a></p>
