  ...
  return (
    <>
      {visible && (
        ...
        <p class="text-md text-white mt-1 text-center">Welcome to the third rewrite of the MSHA Builders Club site! Please note that this website is unfinished and has many bugs.</p>
